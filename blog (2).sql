...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 28 Mar 2017, 21:56:57
...
CREATE TABLE IF NOT EXISTS `kullanicilar` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin5 AUTO_INCREMENT=18 ;
...
CREATE TABLE IF NOT EXISTS `yazilar` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf16 COLLATE=utf16_turkish_ci AUTO_INCREMENT=36 ;
...
CREATE TABLE IF NOT EXISTS `yorumlar` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf16 COLLATE=utf16_turkish_ci AUTO_INCREMENT=91 ;
...
(89, 'ghostboy08', 'Başarılı..', 33, '2017-03-28 19:11:13');

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `yorum_like`
--

DROP TABLE IF EXISTS `yorum_like`;
CREATE TABLE IF NOT EXISTS `yorum_like` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Tablo döküm verisi `yorum_like`
--

INSERT INTO `yorum_like` (`id`, `yorum_id`, `like`, `dislike`) VALUES
(1, 83, 4, 2),
(5, 88, 0, 0),
(6, 87, 15, 2),
(7, 89, 0, 0),
