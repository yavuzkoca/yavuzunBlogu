					...
					<div id="main">
						...
						<!-- Pagination -->
							<ul class="actions pagination">
								<li><a href="yazilar.php?page=<?php echo $page - 1 ?>" class="<?php if($page == 1){echo "disabled ";}else {echo " ";} ?>button big previous">Önceki Sayfa</a></li>
								<li><a href="yazilar.php?page=<?php echo $page + 1 ?>" class="<?php if($page*$how_many > $yazilarin_sayisi){echo "disabled ";}else {echo "";} ?>button big next">Sonraki Sayfa</a></li>
							</ul>
